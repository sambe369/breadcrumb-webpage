          ...
          <div className="row">
            ...
            <div className="information col-md-6">
              ...
              <div className="address">
                <p><b>Phone:</b> +977 9841186190, 9765232597</p>
                <p><b>Email:</b> breadcrumbtechnologies@gmail.com</p>
                <p><b>Address:</b> Devinagar-10, Kathmandu</p>
              </div>
              <div className="form mt-5">
                <div className="info_1">
                  <h4>Send us a message:</h4>
                  <p>Want to make contact with us? Please fill in the details below.</p>
                </div>
