        ...
        <div className="container">
          <div className="row align-items-center justify-content-between">
            <div className="col-md">
              <span><img className='img-fluid' src="frontend green.svg" alt="" width={500} /></span>
            </div>
            <div className="col-md">
              <span><h2>IT Consultancy</h2></span> 
...
export default Services_section_4